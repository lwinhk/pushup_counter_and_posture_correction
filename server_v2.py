...
def end_session():
    ...
    session_data = {
        ...
        "user_id": user_id,
        "counter": count,
        "incorrect_counter": incorrect_count,
        "correct_counter": correct_count,
...
def is_posture_correct(leftShoulder, leftHip, leftKnee, rightShoulder, rightHip, rightKnee):
    pass

def angles(frame, leftShoulderLandMark, leftElbowLandMark, leftWristLandMark, leftHipLandMark, leftKneeLandMark, rightShoulderLandMark, rightElbowLandMark, rightWristLandMark, rightHipLandMark, rightKneeLandMark, drawPoints):
    global count
    global direction
    global DOWN
    global UP
    ...
    posture_correct = is_posture_correct(leftShoulder, leftHip, leftKnee, rightShoulder, rightHip, rightKnee)
